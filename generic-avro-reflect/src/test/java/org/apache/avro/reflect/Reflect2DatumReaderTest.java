...
import org.apache.avro.reflect.data.*;
...
class Reflect2DatumReaderTest {
    ...
    void testGenericClass() throws IOException {
        final Reflect2Data reflectData = Reflect2Data.get();
        final Schema schema = reflectData.getSchema(new TypeToken<GenericClass<String>>() {}.getType());
    ...
    static <T> void verify(T nestedValueClass, DatumWriter<T> datumWriter, DatumReader<T> datumReader, boolean reuse) throws IOException {
